...
def main():
    ...
    for motion in tqdm(motions):
        ...
        args_cli.output_name = f"source/robot_lab/robot_lab/tasks/manager_based/beyondamp/config/cyborg/motion/stand/{basename}.npz"
        print(args_cli.output_name)

        run_simulator(motion, sim, scene)

# python scripts/tools/beyondmimic/pkl_to_npz.py -f /home/cyborg/Desktop/datas/Cyborg/motion/ACCAD/Female1General_c3d/A2_-_Sway_stageii.pkl --input_fps 30
