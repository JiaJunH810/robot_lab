...
class RolloutStorageElastic:
    ...
    class Transition:
        ...
        def __init__(self) -> None:
            ...
            self.elastic_obs: torch.Tensor | None = None
    ...
    def __init__(
        ...
        self.elastic_obs = torch.zeros(num_transitions_per_env, num_envs, obs["elastic"].shape[-1], device=self.device)
        self.elastic_gt = torch.zeros(num_transitions_per_env, num_envs, 5, device=self.device)
    ...
    def add_transition(self, transition: Transition) -> None:
        ...
        self.elastic_obs[self.step].copy_(transition.elastic_obs)
        self.elastic_gt[self.step].copy_(transition.elastic_gt)
    ...
    def mini_batch_generator(self, num_mini_batches: int, num_epochs: int = 8) -> Generator:
        ...
        elastic_obs = self.elastic_obs.flatten(0, 1)
        elastic_gt = self.elastic_gt.flatten(0, 1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                elastic_obs_batch = elastic_obs[batch_idx]
                elastic_gt_batch = elastic_gt[batch_idx]
