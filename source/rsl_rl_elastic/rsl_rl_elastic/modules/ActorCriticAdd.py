...
from .critic import MoeCritic
from .actor import MoeActor

class ActorCriticAdd(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        self.critic = MLP(num_critic_obs + num_future, 1, critic_hidden_dims, activation)
