...
from rsl_rl_elastic.algorithms import PPOVae
...
from rsl_rl_elastic.modules import ActorCriticVae
from rsl_rl_elastic.storage import RolloutStorageVae
...
class OnPolicyRunnerVae:
    ...
    def _construct_algorithm(self, obs: TensorDict) -> PPOVae:
