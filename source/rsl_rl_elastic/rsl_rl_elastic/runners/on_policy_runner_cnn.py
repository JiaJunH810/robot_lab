...
from rsl_rl_elastic.algorithms import PPOCNN
...
from rsl_rl_elastic.modules import ActorCriticElastic, Elastic, ActorCriticCNN
...
class OnPolicyRunnerCNN:
    ...
    def _construct_algorithm(self, obs: TensorDict) -> PPOCNN:
