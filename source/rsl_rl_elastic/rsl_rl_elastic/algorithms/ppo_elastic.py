...
class PPOElastic:
    ...
    def __init__(
        ...
        self.elastic.to(self.device)

        # Create the optimizer
        self.optimizer = optim.Adam(self.policy.parameters(), lr=learning_rate)
        self.optimizer_elastic = optim.Adam(self.elastic.parameters(), lr=learning_rate * 0.1)
    ...
    def process_env_step(
        self, obs: TensorDict, rewards: torch.Tensor, dones: torch.Tensor, extras: dict[str, torch.Tensor], elastic_obs: torch.Tensor, elastic_gt: torch.Tensor
    ) -> None:
        ...
        self.transition.elastic_obs = elastic_obs
        self.transition.elastic_gt = elastic_gt
    ...
    def update(self) -> dict[str, float]:
        ...
        for (
            ...
            elastic_loss = self.update_elastic(elastic_obs_batch, elastic_gt_batch)
            ...
            mean_elastic_loss += elastic_loss.item()
        ...
        loss_dict = {
            ...
            "elastic_loss": mean_elastic_loss
        }
        if self.rnd:
