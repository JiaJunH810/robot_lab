...
import robot_lab.tasks.manager_based.vaemimic.mdp as mdp
...
class ObservationsCfg:
    ...
    @configclass
    class VqvaeCfg(ObsGroup):
        vqvae_code = ObsTerm(func=mdp.vqvae_code, params={"command_name": "motion"})

    # observation groups
    policy: PolicyCfg = PolicyCfg()
    critic: CriticCfg = CriticCfg()
    future: FutureCfg = FutureCfg()
    vqvae: VqvaeCfg = VqvaeCfg()
