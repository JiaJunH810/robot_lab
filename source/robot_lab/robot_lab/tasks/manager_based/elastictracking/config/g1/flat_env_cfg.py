...
from robot_lab.tasks.manager_based.elastictracking.tracking_env_cfg import BeyondMimicEnvCfg
...
class UnitreeG1BeyondMimicFlatEnvCfg(BeyondMimicEnvCfg):
    def __post_init__(self):
        ...
        self.commands.motion.motion_file = f"{os.path.dirname(__file__)}/motion/motions/gvhmr_single_stand.npz"   # 加载运动序列
