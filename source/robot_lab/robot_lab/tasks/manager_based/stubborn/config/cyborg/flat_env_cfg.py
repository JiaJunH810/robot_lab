...
from robot_lab.tasks.manager_based.stubborn.tracking_env_cfg import CyborgEnvCfg


@configclass
class CyborgStubbornFlatEnvCfg(CyborgEnvCfg):
    def __post_init__(self):
        ...
        self.commands.motion.motion_file = f"{os.path.dirname(__file__)}/motion/fallAndGetUp1_subject1_2070_to_2210_collect.npz"
