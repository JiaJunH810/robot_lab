...
class MotionLoader:
    def __init__(self, motion_file: str, body_indexes: Sequence[int], anchor_index: int, future_body_indexes: Sequence[int], device: str = "cpu"):
...
class MotionCommand(CommandTerm):
    ...
    def __init__(self, cfg: MotionCommandCfg, env: ManagerBasedRLEnv):
        ...
        self.motion = MotionLoader(self.cfg.motion_file, self.body_indexes, self.robot_anchor_body_index, self.future_body_indexes, device=self.device)
