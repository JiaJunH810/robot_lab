...
gym.register(
    id="RobotLab-Isaac-MoeCritic-Flat-Unitree-G1-v0",
    # entry_point="isaaclab.envs:ManagerBasedRLEnv",
    entry_point="robot_lab.envs:MoeG1Env",
    disable_env_checker=True,   # 关闭安检
    kwargs={
        "env_cfg_entry_point": f"{__name__}.flat_env_cfg:UnitreeG1BeyondMimicFlatEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:UnitreeG1MoeCriticFlatPPORunnerCfg",
    },
)
'''
entry_point: 选取哪种环境
