...
class AddG1Env(ManagerBasedRLEnv):
    ...
    def get_discriminator_observations(self) -> tuple[torch.Tensor, dict]:
        if hasattr(self.unwrapped, "observation_manager"):
            obs_dict = self.unwrapped.observation_manager.compute()
        else:
            obs_dict = self.unwrapped._get_observations()
        return obs_dict["discriminator"]
    ...
    def step(self, action: torch.Tensor) -> VecEnvStepReturn:
        ...
        diff_obs = self.get_discriminator_observations()
        ...
        self.obs_buf['discriminator'] = diff_obs
